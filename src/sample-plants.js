// This is just some sample data before we hook up API data
...
const plants = {
    plant1: {
      ...
      desc:
        "Monstera deliciosa is a species of evergreen tropical vine that is a part of Araceae, the aroid family. Native to the Tropical Americas, it is one of the few aroids which produces edible fruit, hence the species epithet deliciosa.",
      price: 30,
      status: "available"
    },
    ...
    plant3: {
      ...
      desc:
        "Calathea plants are part of the family of plants known as Marantaceae, which is a species of flowering plants from tropical areas such as Africa. They are famous for their wide, green, colorful leaves.",
      price: 40,
      status: "unavailable"
    },
